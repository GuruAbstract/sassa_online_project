                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('addproduct') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('productid') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="productid" type="text" class="form-control" name="productid" value="{{ old('productid') }}" required autofocus/>
                        ...
                        <div class="form-group{{ $errors->has('discountpercentage') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="discountpercentage" type="text" class="form-control" name="discountpercentage" value="{{ old('discountpercentage') }}" required autofocus/>
                        ...
                        <div class="form-group{{ $errors->has('purchaseprice') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="purchaseprice" type="text" class="form-control" name="purchaseprice" value="{{ old('purchaseprice') }}" required autofocus/>
                        ...
                        <div class="form-group{{ $errors->has('sellingprice') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="sellingprice" type="tel" class="form-control" name="sellingprice" value="{{ old('sellingprice') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('stocklevel') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="stocklevel" type="number" class="form-control" name="stocklevel" value="{{ old('stocklevel') }}" required min="1">
                            ...
                            <div class="form-group{{ $errors->has('productquantity') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="productquantity" type="number" class="form-control" name="productquantity" value="{{ old('productquantity') }}" required min="1">
                            ...
                            <div class="form-group{{ $errors->has('reorderlevel') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="reorderlevel" type="number" class="form-control" name="reorderlevel" value="{{ old('reorderlevel') }}" required min="1">
                        ...
                        <div class="form-group{{ $errors->has('productdescription') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea style="border: #5bc0de; border-style: solid "  id="productdescription"  class="form-control" name="productdescription" required COLS="20" ROWS="6"></textarea>
                      ...
                      <div class="jumbotron" style="background-color:maroon;color: white ">
                       You are not Authorized to add products to the system
                      </div>
                    @endcan
